            ...
            <Link href={href} legacyBehavior passHref>
                <NavigationMenuLink 
                    ...
                    className={cn(
                        ...
                        "w-full text-base justify-start hover:bg-primary/80 focus:bg-primary/80 hover:text-white focus:text-white data-[state=open]:bg-primary data-[active]:bg-primary"
                    )}
                >
                    {children}
                </NavigationMenuLink>
                        ...
                        <NavigationMenuItem key={index} className='w-full flex ml-0'>
                            <Link href={item.url} legacyBehavior passHref>
                                <NavigationMenuLink 
                                    ...
                                    className={cn(
                                        navigationMenuTriggerStyle(),
                                        "w-full justify-start hover:bg-primary/80 focus:bg-primary/80 hover:text-white focus:text-white data-[state=open]:bg-primary data-[active]:bg-primary"
                                    )}
                                >
                                    {item.name}
                                </NavigationMenuLink>
