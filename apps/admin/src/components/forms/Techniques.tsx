...
export default function Techniques({ row }: { row: Row<TechniqueForTable> }) {
  return (
    <div className="flex w-full flex-col gap-6 pt-3">
      ...
      <div className="flex flex-wrap items-center gap-6">
        ...
        <div className="min-w-full flex-1 sm:min-w-[15rem]">
          <p className="mb-2 text-center font-medium">Изоб. искусства</p>
          <div className="text-center">{row.original.art}</div>
        </div>
      </div>
