...
export default function BookGenres({ row }: { row: Row<BookGenreForTable> }) {
  return (
    <div className="flex w-full flex-col gap-6 pt-3">
      ...
      <div className="flex flex-wrap items-center gap-6">
        <div className="min-w-full flex-1 sm:min-w-[20rem]">
          ...
          <FormTextArea
            name={`bookGenres[${row.index}].displayName`}
        ...
        <div className="min-w-full flex-1 sm:min-w-[20rem]">
          ...
          <FormTextArea
            name={`bookGenres[${row.index}].description`}
      ...
      <div className="flex flex-wrap items-center gap-6">
        ...
        <div className="min-w-full flex-1 sm:min-w-[20rem]">
          ...
          <FormTextArea
            name={`bookGenres[${row.index}].externalLink`}
