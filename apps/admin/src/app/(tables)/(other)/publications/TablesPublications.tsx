import type { EntityEnum, PublicationsForTable } from '@siberiana/schemas';
...
export default async function TablesPublications({
  searchParams,
}: {
  searchParams: { [key: string]: string | string[] | undefined };
}) {

  const entity: EntityEnum = "publications";
  ...
  const defaultAdd: PublicationsForTable = {
  ...
  const dataForUpdate: PublicationsForTable[] = dataResult.value.edges.map(
    (data) => {
