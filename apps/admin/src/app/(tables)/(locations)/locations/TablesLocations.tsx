import type { EntityEnum, LocationsForTable } from '@siberiana/schemas';
...
export default async function TablesLocations({
  searchParams,
}: {
  searchParams: { [key: string]: string | string[] | undefined };
}) {
  const entity: EntityEnum = "locations";
  ...
  const defaultAdd: LocationsForTable = {
  ...
  const dataForUpdate: LocationsForTable[] = dataResult.value.edges.map(
    (data) => {
