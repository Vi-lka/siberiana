...
const nextConfig = {
  ...
  env: {
    ...
    FEEDBACK_MAIL_HOST: process.env.FEEDBACK_MAIL_HOST,
    FEEDBACK_MAIL_PORT: process.env.FEEDBACK_MAIL_PORT,
    FEEDBACK_MAIL_USER: process.env.FEEDBACK_MAIL_USER,
    FEEDBACK_MAIL_PASS: process.env.FEEDBACK_MAIL_PASS,
    FEEDBACK_MAIL_TO: process.env.FEEDBACK_MAIL_TO,
  },
  images: {
    remotePatterns: [
      {
