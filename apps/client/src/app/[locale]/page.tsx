...
import HomeImgSlider from "~/components/home/home-img-slider";
...
export default async function Home({
  ...
  return (
    <main className="font-Inter flex h-[85vh] flex-col items-center justify-between">
