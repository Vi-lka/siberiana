        ...
        {created && !!instanceRef.current ? (
          data.length > 1 ? (
            <>
              ...
              <ArrowLeft
                className="text-input bg-accent absolute bottom-6 left-2 h-8 w-8 cursor-pointer rounded-md bg-opacity-20 transition-all hover:scale-125 md:top-1/2 md:translate-y-1/2"
                onClick={() => instanceRef.current?.prev()}
              />
              <ArrowRight
                className="text-input bg-accent absolute bottom-6 right-2 h-8 w-8 cursor-pointer rounded-md bg-opacity-20 transition-all hover:scale-125 md:top-1/2 md:translate-y-1/2"
