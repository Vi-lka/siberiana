...
© 2023 - настоящее время. Все права защищены. Информацию о лицензии см. в
разделе LICENSE.

---

УВЕДОМЛЕНИЯ О ПРОГРАММНОМ ОБЕСПЕЧЕНИИ СТОРОННИХ ЛИЦ

Проект включает в себя компоненты из проектов и продуктов, перечисленных ниже.
Первоначальные уведомления об авторских правах и лицензии, по которым
распространяются эти компоненты, приведены ниже.

---

## Turbo

Наш продукт содержит «Turborepo» от Vercel.

Turborepo — это высокопроизводительная система сборки для кодовых баз JavaScript
и TypeScript.
